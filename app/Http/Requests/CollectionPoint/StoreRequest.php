...
class StoreRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'name.unique' => 'Já existe um ponto com este nome.',
            ...
            'cep.regex' => 'O formato do CEP é inválido. Exemplo válido: 12345-678.',
            ...
            'categories-id.*.exists' => 'Alguma das categorias selecionadas é inválida.',

            'days_open.required' => 'Informe pelo menos um dia de funcionamento.',
            'days_open.array' => 'O campo dias de funcionamento deve ser uma lista.',
            'days_open.*.string' => 'Cada dia de funcionamento deve ser um texto.',
